...
const group: LegacyGroup = {
  ...
  packs: [
    ...
    { kind: 'pack', label:'Transform (Universes Beyond) (Front)', id: 'M15TransformUBFront' },
    { kind: 'pack', label:'Transform (Universes Beyond) (Back)', id: 'M15TransformUBBackNew' },
    { kind: 'pack', label:'Modal DFCs (Universes Beyond)', id:'ModalUB' },
    { kind: 'pack', label:'Rooms (Universes Beyond)', id:'RoomUB' },
    { kind: 'pack', label:'Sagas (Universes Beyond)', id:'SagaUB' },
    { kind: 'pack', label:'Spree (Universes Beyond)', id:'SpreeUB' },

    { kind: 'label', label:'Addons' },
    { kind: 'pack', label:'Legend Crowns (Universes Beyond)', id:'UBLegendCrowns' },
    { kind: 'pack', label:'Legend Crowns (Transform) (Universes Beyond)', id:'TransformLegendCrownsUB' },
    { kind: 'pack', label:'Legend Crowns (MDFC) (Universes Beyond)', id:'ModalLegendCrownsUB' },
