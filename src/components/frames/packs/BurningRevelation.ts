...
const masks: Mask[] = [
  { src: '/img/frames/sld/burningRevelations/maskFrame.png', name: 'Frame' },
  { src: '/img/frames/sld/burningRevelations/maskPinline.png', name: 'Pinline' },
  { src: '/img/frames/sld/burningRevelations/maskRules.png', name: 'Rules' },
  { src: '/img/frames/sld/burningRevelations/maskBorder.png', name: 'Border' }
];

const crownMasks: Mask[] = [
  { src: '/img/frames/sld/burningRevelations/maskCrownBorder.png', name: 'Border' }
];

const ptBounds: Bounds = { x: 1582 / 2010, y: 2490 / 2814, width: 337 / 2010, height: 179 / 2814 };
const crownBounds: Bounds = { x: 101 / 2010, y: 43 / 2814, width: 1829 / 2010, height: 267 / 2814 };

const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/sld/burningRevelations/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/sld/burningRevelations/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/sld/burningRevelations/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/sld/burningRevelations/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/sld/burningRevelations/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/sld/burningRevelations/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/sld/burningRevelations/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/sld/burningRevelations/l.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/sld/burningRevelations/c.png', masks },
...
const template: FramePackTemplate = {
  id: 'BurningRevelation',
  label: 'Burning Revelation (SLD)',
  version: 'burningRevelations',
  artBounds: { x: 149 / 2010, y: 315 / 2814, width: 1719 / 2010, height: 1255 / 2814 },
  setSymbolBounds: { x: 0.9213, y: 1660 / 2814, width: 0.12, height: 0.0410, vertical: 'center', horizontal: 'right' },
