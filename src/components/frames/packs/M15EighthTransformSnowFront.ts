...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/l.png', masks },
  ...
  { name: 'White Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/wl.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/ul.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/bl.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/rl.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/gl.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/snow/ml.png', masks },
  { name: 'M15 Border', src: '/img/frames/m15/transform/regular/maskBorderFront.png' },
];

const template: FramePackTemplate = {
  id: 'M15EighthTransformSnowFront',
  label: 'Snow (Front)',
  version: 'm15EighthTransformSnowFront',
