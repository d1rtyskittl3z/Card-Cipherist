...
// Shared masks for M15 Eighth Token frames
const masks: Mask[] = [
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/m15-eighth/token/regular/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/m15-eighth/token/regular/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/m15-eighth/token/regular/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/m15-eighth/token/regular/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/m15-eighth/token/regular/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/m15-eighth/token/regular/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/m15-eighth/token/regular/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/m15-eighth/token/regular/l.png', masks },
