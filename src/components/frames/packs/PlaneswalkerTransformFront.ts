...
const template: FramePackTemplate = {
  ...
  frames: [
    { name: 'White Frame (Front)', src: '/img/frames/planeswalker/transform/wf.png', masks },
    { name: 'Blue Frame (Front)', src: '/img/frames/planeswalker/transform/uf.png', masks },
    { name: 'Black Frame (Front)', src: '/img/frames/planeswalker/transform/bf.png', masks },
    { name: 'Red Frame (Front)', src: '/img/frames/planeswalker/transform/rf.png', masks },
    { name: 'Green Frame (Front)', src: '/img/frames/planeswalker/transform/gf.png', masks },
    { name: 'Multicolored Frame (Front)', src: '/img/frames/planeswalker/transform/mf.png', masks }
  ],
  text: {
