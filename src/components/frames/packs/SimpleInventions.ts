...
const masks: Mask[] = [
  ...
  { src: '/img/frames/custom/simpleInvention/maskFrame.png', name: 'Filigree' },
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/simpleInvention/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/simpleInvention/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/simpleInvention/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/simpleInvention/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/simpleInvention/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/simpleInvention/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/simpleInvention/a.png', masks },
  { name: 'Gold Trim', src: '/img/frames/custom/simpleInvention/goldTrim.png' },
...
const template: FramePackTemplate = {
  id: 'SimpleInventions',
  label: 'Simple Inventions',
  version: 'simpleInventions',
