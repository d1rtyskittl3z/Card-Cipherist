...
const masks: Mask[] = [
  { src: '/img/frames/planeswalker/mdfc/pinline.svg', name: 'Pinline' },
  { src: '/img/frames/modal/modalMaskReminder.png', name: 'Reminder' },
  { src: '/img/frames/planeswalker/mdfc/title.svg', name: 'Title' },
...
const template: FramePackTemplate = {
  ...
  frames: [
    { name: 'White Frame', src: '/img/frames/planeswalker/mdfc/wf.png', masks },
    { name: 'Blue Frame', src: '/img/frames/planeswalker/mdfc/uf.png', masks },
    { name: 'Black Frame', src: '/img/frames/planeswalker/mdfc/bf.png', masks },
    { name: 'Red Frame', src: '/img/frames/planeswalker/mdfc/rf.png', masks },
    { name: 'Green Frame', src: '/img/frames/planeswalker/mdfc/gf.png', masks },
    { name: 'Multicolored Frame', src: '/img/frames/planeswalker/mdfc/mf.png', masks },
    { name: 'White Frame', src: '/img/frames/planeswalker/mdfc/wb.png', masks },
    { name: 'Blue Frame', src: '/img/frames/planeswalker/mdfc/ub.png', masks },
    { name: 'Black Frame', src: '/img/frames/planeswalker/mdfc/bb.png', masks },
    { name: 'Red Frame', src: '/img/frames/planeswalker/mdfc/rb.png', masks },
    { name: 'Green Frame', src: '/img/frames/planeswalker/mdfc/gb.png', masks },
    { name: 'Multicolored Frame', src: '/img/frames/planeswalker/mdfc/mb.png', masks }
  ],
  text: {
