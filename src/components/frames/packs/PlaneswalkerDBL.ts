...
const template: FramePackTemplate = {
  id: 'PlaneswalkerDBL',
  label: 'Innistrad: Double Feature',
  version: 'planeswalkerDBL',
  ...
  frames: [
    { name: 'White Frame', src: '/img/frames/planeswalker/dbl/w.png', masks },
    { name: 'Blue Frame', src: '/img/frames/planeswalker/dbl/u.png', masks },
    { name: 'Black Frame', src: '/img/frames/planeswalker/dbl/b.png', masks },
    { name: 'Red Frame', src: '/img/frames/planeswalker/dbl/r.png', masks },
    { name: 'Green Frame', src: '/img/frames/planeswalker/dbl/g.png', masks },
    { name: 'Multicolored Frame', src: '/img/frames/planeswalker/dbl/m.png', masks },
