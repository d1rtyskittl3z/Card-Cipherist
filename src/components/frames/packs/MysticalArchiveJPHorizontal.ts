...
// Shared masks for horizontal frames
const masks: Mask[] = [
  { src: '/img/frames/mysticalArchive/jp/pinline.svg', name: 'Pinline' },
  { src: '/img/frames/mysticalArchive/jp/horizontal/rightHalf.svg', name: 'Right Half' },
];

// Stretch configuration for adjustable title bar (horizontal) and type bar
...
const frames: FrameItem[] = [
  // Main horizontal frames with stretch
  { name: 'White Frame', src: '/img/frames/mysticalArchive/jp/horizontal/w.svg', stretch, masks },
  { name: 'Blue Frame', src: '/img/frames/mysticalArchive/jp/horizontal/u.svg', stretch, masks },
  { name: 'Black Frame', src: '/img/frames/mysticalArchive/jp/horizontal/b.svg', stretch, masks },
  { name: 'Red Frame', src: '/img/frames/mysticalArchive/jp/horizontal/r.svg', stretch, masks },
  { name: 'Green Frame', src: '/img/frames/mysticalArchive/jp/horizontal/g.svg', stretch, masks },
  { name: 'Multicolored Frame', src: '/img/frames/mysticalArchive/jp/horizontal/m.svg', stretch, masks },
  { name: 'Artifact Frame', src: '/img/frames/mysticalArchive/jp/horizontal/a.svg', stretch, masks },
  { name: 'Land Frame', src: '/img/frames/mysticalArchive/jp/horizontal/l.svg', stretch, masks },

  // Set symbol rarity frames (shared with vertical version)
  ...
  // Power/Toughness frames with complementary cutout (shared with vertical version)
...
const template: FramePackTemplate = {
  id: 'MysticalArchiveJPHorizontal',
  label: 'Horizontal Japanese Mystical Archive (STA)',
  version: 'mysticalArchiveJPHorizontal',
//   notice: 'When you load the Horizontal Japanese Mystical Archive frame version, a "Japanese Mystical Archive Horizontal" tab will appear. This tab allows you to control the height of the title bar and width of the type bar. For a better Japanese font, use {fontjapanese-title} or {fontjapanese}.',
