...
const template: FramePackTemplate = {
  id: 'PlaneswalkerTransformBack',
  label: 'Transform (Back)',
  version: 'planeswalkerTransformBack',
  ...
  frames: [
    { name: 'White Frame (Back)', src: '/img/frames/planeswalker/transform/wb.png', masks },
    { name: 'Blue Frame (Back)', src: '/img/frames/planeswalker/transform/ub.png', masks },
    { name: 'Black Frame (Back)', src: '/img/frames/planeswalker/transform/bb.png', masks },
    { name: 'Red Frame (Back)', src: '/img/frames/planeswalker/transform/rb.png', masks },
    { name: 'Green Frame (Back)', src: '/img/frames/planeswalker/transform/gb.png', masks },
    { name: 'Multicolored Frame (Back)', src: '/img/frames/planeswalker/transform/mb.png', masks },
