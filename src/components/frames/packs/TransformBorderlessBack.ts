...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/transform/borderless/wb.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/transform/borderless/ub.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/transform/borderless/bb.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/transform/borderless/rb.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/transform/borderless/gb.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/transform/borderless/mb.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/transform/borderless/ab.png', masks },
...
const template: FramePackTemplate = {
  id: 'TransformBorderlessBack',
  label: 'Borderless (Back)',
  version: 'transformBorderlessBack',
