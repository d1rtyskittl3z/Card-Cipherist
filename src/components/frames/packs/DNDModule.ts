...
const template: FramePackTemplate = {
  id: 'DNDModule',
  label: 'D&D Module (AFR)',
  version: 'dndModule',
  artBounds: { x: 0.0394, y: 0.1929, width: 0.9214, height: 0.4115 },
  setSymbolBounds: { x: 0.9167, y: 0.63, width: 0.12, height: 0.0410, vertical: 'center', horizontal: 'right' },
  watermarkBounds: { x: 0.5, y: 0.7953, width: 0.75, height: 0.2305 },
  frames,
  text: {
