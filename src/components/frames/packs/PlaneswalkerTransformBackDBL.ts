...
const masks: Mask[] = [
  { src: '/img/frames/planeswalker/transform/pinline.svg', name: 'Pinline' },
  ...
  { src: '/img/frames/planeswalker/transform/frame.svg', name: 'Frame' },
  { src: '/img/frames/planeswalker/regular/planeswalkerMaskBorder.png', name: 'Border' }
];

const template: FramePackTemplate = {
  id: 'PlaneswalkerTransformBackDBL',
  label: 'Innistrad: Double Feature: Transform (Back)',
  version: 'planeswalkerTransformBackDBL',
  ...
  frames: [
    { name: 'White Frame (Back)', src: '/img/frames/planeswalker/transform/dbl/wb.png', masks },
    { name: 'Blue Frame (Back)', src: '/img/frames/planeswalker/transform/dbl/ub.png', masks },
    { name: 'Black Frame (Back)', src: '/img/frames/planeswalker/transform/dbl/bb.png', masks },
    { name: 'Red Frame (Back)', src: '/img/frames/planeswalker/transform/dbl/rb.png', masks },
    { name: 'Green Frame (Back)', src: '/img/frames/planeswalker/transform/dbl/gb.png', masks },
    { name: 'Multicolored Frame (Back)', src: '/img/frames/planeswalker/transform/dbl/mb.png', masks },
