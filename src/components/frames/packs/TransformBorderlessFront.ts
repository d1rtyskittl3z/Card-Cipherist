...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/transform/borderless/wf.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/transform/borderless/uf.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/transform/borderless/bf.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/transform/borderless/rf.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/transform/borderless/gf.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/transform/borderless/mf.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/transform/borderless/af.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/transform/borderless/lf.png', masks },
...
const template: FramePackTemplate = {
  id: 'TransformBorderlessFront',
  label: 'Borderless (Front)',
  version: 'transformBorderlessFront',
