...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/new/fullart/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/new/fullart/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/new/fullart/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/new/fullart/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/new/fullart/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/new/fullart/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/new/fullart/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/new/fullart/l.png', masks },
  //MISSING { name: 'Eldrazi Frame', src: '/img/frames/m15/new/fullart/c.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/m15/new/fullart/v.png', masks },
  ...
  { name: 'White Land Frame', src: '/img/frames/m15/new/fullart/lw.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/m15/new/fullart/lu.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/m15/new/fullart/lb.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/m15/new/fullart/lr.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/m15/new/fullart/lg.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/m15/new/fullart/lm.png', masks },
];
