...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/omen/regular/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/omen/regular/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/omen/regular/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/omen/regular/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/omen/regular/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/omen/regular/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/omen/regular/a.png', masks },
//   { name: 'Colorless Frame', src: '/img/frames/omen/regular/c.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/omen/regular/v.png', masks },
  { name: 'Land Frame', src: '/img/frames/omen/regular/l.png', masks },
  ...
  { name: 'White Enchantment Frame', src: '/img/frames/omen/nyx/w.png', masks },
  { name: 'Blue Enchantment Frame', src: '/img/frames/omen/nyx/u.png', masks },
  { name: 'Black Enchantment Frame', src: '/img/frames/omen/nyx/b.png', masks },
  { name: 'Red Enchantment Frame', src: '/img/frames/omen/nyx/r.png', masks },
  { name: 'Green Enchantment Frame', src: '/img/frames/omen/nyx/g.png', masks },
  { name: 'Multicolored Enchantment Frame', src: '/img/frames/omen/nyx/m.png', masks },
  { name: 'Artifact Enchantment Frame', src: '/img/frames/omen/nyx/a.png', masks },
];

// Template
const template: FramePackTemplate = {
  id: 'Omen',
  label: 'Omens (Tarkir Dragonstorm)',
  version: 'omen',
