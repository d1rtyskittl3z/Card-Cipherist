...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/transform/snow/backW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/transform/snow/backU.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/transform/snow/backB.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/transform/snow/backR.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/transform/snow/backG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/transform/snow/backM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/transform/snow/backA.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/transform/snow/backL.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15TransformSnowBack',
  label: 'Snow (Back, top-left icon)',
  version: 'm15TransformSnowBack',
