...
const masks: Mask[] = [
  ...
  { src: '/img/frames/old/floating/frame.svg', name: 'Frame' },
  { src: '/img/frames/old/floating/pinline.svg', name: 'Pinline' },
  { src: '/img/frames/old/floating/rules.svg', name: 'Rules' },
];

const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/old/floating/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/old/floating/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/old/floating/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/old/floating/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/old/floating/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/old/floating/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/old/floating/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/old/floating/l.png', masks },
  { name: 'White Land Frame', src: '/img/frames/old/floating/land/w.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/old/floating/land/u.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/old/floating/land/b.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/old/floating/land/r.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/old/floating/land/g.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/old/floating/c.png', masks },
...
const template: FramePackTemplate = {
  ...
  watermarkBounds: { x: 0.5, y: 0.7429, width: 0.6, height: 0.25 },
  frames,
  text: {
