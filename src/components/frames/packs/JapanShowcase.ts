...
const bounds: Bounds = { x: 0.7771, y: 0.8876, width: 0.1720, height: 0.0593 };
const bounds2: Bounds = { x: 1562 / 2010, y: 2525 / 2814, width: 0.1720, height: 0.0593 };
const boundsStamp: Bounds = { x: 877 / 2010, y: 2537 / 2814, width: 0.1264, height: 0.0452 };
const bounds3: Bounds = { x: 0, y: 0, width: 1, height: 1 };

const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/japanShowcase/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/japanShowcase/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/japanShowcase/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/japanShowcase/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/japanShowcase/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/japanShowcase/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/japanShowcase/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/japanShowcase/Land.png', masks },
  { name: 'Black Frame (Alt)', src: '/img/frames/m15/japanShowcase/bAlt.png', masks },
  { name: 'Border', src: '/img/frames/m15/japanShowcase/border.png', bounds: bounds3 },

  { name: 'White Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/w.png', masks: masks2, bounds },
  { name: 'Blue Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/u.png', masks: masks2, bounds },
  { name: 'Black Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/b.png', masks: masks2, bounds },
  { name: 'Red Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/r.png', masks: masks2, bounds },
  { name: 'Green Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/g.png', masks: masks2, bounds },
  { name: 'Multicolored Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/m.png', masks: masks2, bounds },
  { name: 'Artifact Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/a.png', masks: masks2, bounds },
  { name: 'Land Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/l.png', masks: masks2, bounds },
  { name: 'Vehicle Power/Toughness', src: '/img/frames/m15/japanShowcase/pt/v.png', masks: masks2, bounds },
  { name: 'Black Power/Toughness (Alt)', src: '/img/frames/m15/japanShowcase/pt/bAlt.png', masks: masks2, bounds },
