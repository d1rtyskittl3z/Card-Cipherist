...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/textless/2022/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/textless/2022/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/textless/2022/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/textless/2022/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/textless/2022/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/textless/2022/m.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/textless/2022/l.png', masks },
  ...
  { name: 'White Snow Frame', src: '/img/frames/textless/2022/snow/w.png', masks },
  { name: 'Blue Snow Frame', src: '/img/frames/textless/2022/snow/u.png', masks },
  { name: 'Black Snow Frame', src: '/img/frames/textless/2022/snow/b.png', masks },
  { name: 'Red Snow Frame', src: '/img/frames/textless/2022/snow/r.png', masks },
  { name: 'Green Snow Frame', src: '/img/frames/textless/2022/snow/g.png', masks },
];

const template: FramePackTemplate = {
  id: 'TextlessBasics2022',
  label: 'Fullart Basics (2022)',
  version: 'textlessBasics2022',
