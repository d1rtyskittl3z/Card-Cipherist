...
const template: FramePackTemplate = {
  id: 'PlaneswalkerSDCC15',
  label: 'Blackout (SDCC15)',
  version: 'planeswalkerSDCC15',
  ...
  frames: [
    { name: 'Frame', src: '/img/frames/planeswalker/sdcc15/frame.svg', masks },
    { name: 'Transform Frame', src: '/img/frames/planeswalker/sdcc15/transform.svg', masks }
  ],
  text: {
