...
const masks: Mask[] = [
  ...
  { src: '/img/frames/promo/extended/frame.svg', name: 'Frame' },
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/promo/extended/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/promo/extended/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/promo/extended/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/promo/extended/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/promo/extended/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/promo/extended/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/promo/extended/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/promo/extended/l.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/promo/extended/c.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/promo/extended/v.png', masks },
