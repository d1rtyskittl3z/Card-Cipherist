...
const masks: Mask[] = [
  ...
  { src: '/img/frames/modal/borderless/pinline.svg', name: 'Pinline' },
...
const frames: FrameItem[] = [
  { name: 'White Frame (Front)', src: '/img/frames/modal/borderless/wf.png', masks },
  { name: 'Blue Frame (Front)', src: '/img/frames/modal/borderless/uf.png', masks },
  { name: 'Black Frame (Front)', src: '/img/frames/modal/borderless/bf.png', masks },
  { name: 'Red Frame (Front)', src: '/img/frames/modal/borderless/rf.png', masks },
  { name: 'Green Frame (Front)', src: '/img/frames/modal/borderless/gf.png', masks },
  { name: 'Multicolored Frame (Front)', src: '/img/frames/modal/borderless/mf.png', masks },
  { name: 'Artifact Frame (Front)', src: '/img/frames/modal/borderless/af.png', masks },
  { name: 'White Frame (Back)', src: '/img/frames/modal/borderless/wb.png', masks },
  { name: 'Blue Frame (Back)', src: '/img/frames/modal/borderless/ub.png', masks },
  { name: 'Black Frame (Back)', src: '/img/frames/modal/borderless/bb.png', masks },
  { name: 'Red Frame (Back)', src: '/img/frames/modal/borderless/rb.png', masks },
  { name: 'Green Frame (Back)', src: '/img/frames/modal/borderless/gb.png', masks },
  { name: 'Multicolored Frame (Back)', src: '/img/frames/modal/borderless/mb.png', masks },
  { name: 'Artifact Frame (Back)', src: '/img/frames/modal/borderless/ab.png', masks },
