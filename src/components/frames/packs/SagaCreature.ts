...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/saga/creature/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/saga/creature/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/saga/creature/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/saga/creature/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/saga/creature/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/saga/creature/m.png', masks },
//   { name: 'Artifact Frame', src: '/img/frames/saga/creature/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/saga/creature/l.png', masks },
...
const template: FramePackTemplate = {
  id: 'SagaCreature',
  label: 'Saga Creature Frames',
  version: 'sagaCreature',
