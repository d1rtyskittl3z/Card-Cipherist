...
const frames: FrameItem[] = [
  // Regular frames (full art)
  { name: 'White Frame', src: '/img/frames/m15/ub/full/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/ub/full/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/ub/full/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/ub/full/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/ub/full/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/ub/full/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/ub/full/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/ub/full/l.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/m15/ub/full/v.png', masks },
  
  // Land frames with color identity
  { name: 'White Land Frame', src: '/img/frames/m15/ub/full/wl.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/m15/ub/full/ul.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/m15/ub/full/bl.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/m15/ub/full/rl.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/m15/ub/full/gl.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/m15/ub/full/ml.png', masks },
...
const template: FramePackTemplate = {
  id: 'UBFull',
  label: 'Universes Beyond (Full art)',
  version: 'ubFull',
