...
const frames: FrameItem[] = [
  // Regular frames (new frames)
  { name: 'White Frame', src: '/img/frames/m15/new/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/new/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/new/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/new/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/new/g.png', masks },
  ...
  { name: 'White Land Frame', src: '/img/frames/m15/new/lw.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/m15/new/lu.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/m15/new/lb.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/m15/new/lr.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/m15/new/lg.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/m15/new/lm.png', masks }
];
