...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/a.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/v.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/l.png', masks },
  ...
  { name: 'White Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/wl.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/ul.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/bl.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/rl.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/gl.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/custom/m15-eighth/transform/front/regular/ml.png', masks },
  { name: 'M15 Border', src: '/img/frames/m15/transform/regular/maskBorderFront.png' },
];

const template: FramePackTemplate = {
  id: 'M15EighthTransformFront',
  label: 'Regular (Front)',
  version: 'm15EighthTransformFront',
