...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/transform/regular/backW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/transform/regular/backU.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/transform/regular/backB.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/transform/regular/backR.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/transform/regular/backG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/transform/regular/backM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/transform/regular/backA.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/m15/transform/regular/backV.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/transform/regular/backL.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15TransformBack',
  label: 'Regular (Back, top-left icon)',
  version: 'm15TransformBack',
