...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/planeswalker/boxTopper/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/planeswalker/boxTopper/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/planeswalker/boxTopper/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/planeswalker/boxTopper/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/planeswalker/boxTopper/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/planeswalker/boxTopper/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/planeswalker/boxTopper/a.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/planeswalker/boxTopper/l.png', masks },
];
...
const template: FramePackTemplate = {
  id: 'PlaneswalkerBoxTopper',
  label: 'Extended Art',
  version: 'planeswalkerRegular',
  artBounds: { x: 0, y: 0.0362, width: 1, height: 0.88 },
