...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/promo/genericShowcase/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/promo/genericShowcase/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/promo/genericShowcase/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/promo/genericShowcase/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/promo/genericShowcase/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/promo/genericShowcase/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/promo/genericShowcase/a.png', masks },
...
const template: FramePackTemplate = {
  id: 'PromoGenericShowcase',
  label: 'Generic Showcase',
  version: 'promoGenericShowcase',
