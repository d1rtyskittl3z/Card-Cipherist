...
const masks: Mask[] = [
  { src: '/img/frames/neonInk/Transform/back/masks/maskCrown.png', name: 'Crown' },
  { src: '/img/frames/neonInk/masks/maskTypePinlines.png', name: 'Type Pinlines' },
  { src: '/img/frames/neonInk/Transform/back/masks/maskTitle.png', name: 'Title' },
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/neonInk/Transform/back/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/neonInk/Transform/back/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/neonInk/Transform/back/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/neonInk/Transform/back/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/neonInk/Transform/back/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/neonInk/Transform/back/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/neonInk/Transform/back/a.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/neonInk/Transform/back/c.png', masks },
  { name: 'Land Frame', src: '/img/frames/neonInk/Transform/back/L.png', masks },
  { name: 'Black Frame (Alt)', src: '/img/frames/neonInk/Transform/back/b(Alt).png', masks },
...
const template: FramePackTemplate = {
  id: 'NeonInkTransformBackTextless',
  label: 'Neon Ink Transform (Back) (TLA)',
  version: 'neonInk',
