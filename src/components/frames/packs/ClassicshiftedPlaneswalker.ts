...
const template: FramePackTemplate = {
  id: 'ClassicshiftedPlaneswalker',
  label: 'Classicshifted Planeswalkers',
  version: 'planeswalkerClassicshifted',
  notice: 'Loads special planeswalker rendering script (versionPlaneswalker.js)',
