...
const masks: Mask[] = [
  { src: '/img/frames/8th/dfc/front/pinline.png', name: 'Pinline' },
  { src: '/img/frames/8th/dfc/front/title.png', name: 'Title' },
  { src: '/img/frames/8th/type.png', name: 'Type' },
  { src: '/img/frames/8th/dfc/front/rules.png', name: 'Rules' },
  { src: '/img/frames/8th/dfc/front/frame.png', name: 'Frame' },
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/8th/dfc/front/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/8th/dfc/front/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/8th/dfc/front/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/8th/dfc/front/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/8th/dfc/front/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/8th/dfc/front/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/8th/dfc/front/a.png', masks },
...
const template: FramePackTemplate = {
  id: '8thTransformFront',
  label: 'Eighth Edition (Transform Front)',
  version: '8thTransformFront',
