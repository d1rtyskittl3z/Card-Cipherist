...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/transform/nyx/backW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/transform/nyx/backU.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/transform/nyx/backB.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/transform/nyx/backR.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/transform/nyx/backG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/transform/nyx/backM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/transform/nyx/backA.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15TransformNyxBack',
  label: 'Nyx (Back, top-left icon)',
  version: 'm15TransformNyxBack',
