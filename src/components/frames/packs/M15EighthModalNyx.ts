...
const frames: FrameItem[] = [
  { name: 'White Frame (Front)', src: '/img/frames/custom/m15-eighth/mdfc/front/nyx/w.png', masks },
  { name: 'Blue Frame (Front)', src: '/img/frames/custom/m15-eighth/mdfc/front/nyx/u.png', masks },
  { name: 'Black Frame (Front)', src: '/img/frames/custom/m15-eighth/mdfc/front/nyx/b.png', masks },
  { name: 'Red Frame (Front)', src: '/img/frames/custom/m15-eighth/mdfc/front/nyx/r.png', masks },
  { name: 'Green Frame (Front)', src: '/img/frames/custom/m15-eighth/mdfc/front/nyx/g.png', masks },
  { name: 'Multicolored Frame (Front)', src: '/img/frames/custom/m15-eighth/mdfc/front/nyx/m.png', masks },
  { name: 'Artifact Frame (Front)', src: '/img/frames/custom/m15-eighth/mdfc/front/nyx/a.png', masks },
  ...
  { name: 'White Frame (Back)', src: '/img/frames/custom/m15-eighth/mdfc/back/nyx/w.png', masks },
  { name: 'Blue Frame (Back)', src: '/img/frames/custom/m15-eighth/mdfc/back/nyx/u.png', masks },
  { name: 'Black Frame (Back)', src: '/img/frames/custom/m15-eighth/mdfc/back/nyx/b.png', masks },
  { name: 'Red Frame (Back)', src: '/img/frames/custom/m15-eighth/mdfc/back/nyx/r.png', masks },
  { name: 'Green Frame (Back)', src: '/img/frames/custom/m15-eighth/mdfc/back/nyx/g.png', masks },
  { name: 'Multicolored Frame (Back)', src: '/img/frames/custom/m15-eighth/mdfc/back/nyx/m.png', masks },
  { name: 'Artifact Frame (Back)', src: '/img/frames/custom/m15-eighth/mdfc/back/nyx/a.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15EighthModalNyx',
  label: 'Nyx (MDFC)',
  version: 'M15EighthModalNyx',
