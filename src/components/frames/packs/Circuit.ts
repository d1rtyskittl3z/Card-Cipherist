...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/circuit/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/circuit/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/circuit/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/circuit/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/circuit/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/circuit/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/circuit/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/circuit/l.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/custom/circuit/v.png', masks },
  { name: 'White Land Frame', src: '/img/frames/custom/circuit/wl.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/custom/circuit/ul.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/custom/circuit/bl.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/custom/circuit/rl.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/custom/circuit/gl.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/custom/circuit/ml.png', masks },
