...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/saga/creature/transform-front/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/saga/creature/transform-front/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/saga/creature/transform-front/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/saga/creature/transform-front/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/saga/creature/transform-front/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/saga/creature/transform-front/m.png', masks },
...
const template: FramePackTemplate = {
  id: 'SagaCreatureFront',
  label: 'Saga Creatures (Front)',
  version: 'sagaCreatureTransformFront',
