...
// Shared masks (empty for Breaking News)
const masks: Mask[] = [];

// Shared bounds for power/toughness boxes
const ptBounds: Bounds = { x: 1507 / 2010, y: 2464 / 2814, width: 406 / 2010, height: 200 / 2814 };

// Shared bounds for legendary crowns
const crownBounds: Bounds = { x: 4 / 2010, y: 2 / 2814, width: 1965 / 2010, height: 72 / 2814 };

const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/breakingNews/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/breakingNews/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/breakingNews/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/breakingNews/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/breakingNews/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/breakingNews/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/breakingNews/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/breakingNews/l.png', masks },
...
const template: FramePackTemplate = {
  id: 'BreakingNews',
  label: 'Breaking News (OTP)',
  version: 'breakingNews',
  artBounds: { x: 106 / 2010, y: 479 / 2814, width: 1802 / 2010, height: 1135 / 2814 },
  setSymbolBounds: { x: 1851 / 2010, y: 1734 / 2814, width: 0.12, height: 0.041, vertical: 'center', horizontal: 'right' },
