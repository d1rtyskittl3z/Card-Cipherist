...
// Shared masks for M15 Eighth Edition Token Textless style frames
const masks: Mask[] = [
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/m15-eighth/token/regular-textless/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/m15-eighth/token/regular-textless/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/m15-eighth/token/regular-textless/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/m15-eighth/token/regular-textless/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/m15-eighth/token/regular-textless/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/m15-eighth/token/regular-textless/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/m15-eighth/token/regular-textless/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/m15-eighth/token/regular-textless/l.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15EighthTokenTextless',
  label: 'Regular (Textless)',
  version: 'm15EighthTokenTextless',
