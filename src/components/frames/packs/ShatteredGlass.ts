...
const masks: Mask[] = [
  { src: '/img/frames/shatteredGlass/masks/maskShatteredRules.png', name: 'No Border' },
];

const bounds = { x: 0, y: 0, width: 1, height: 1 };

const frames: FrameItem[] = [
  { name: 'Shattered Legendary Title', src: '/img/frames/shatteredGlass/ShatteredLegendaryTitle.png', bounds },
  { name: 'Shattered Title', src: '/img/frames/shatteredGlass/ShatteredTitle.png', bounds },
  { name: 'Shattered Rules', src: '/img/frames/shatteredGlass/ShatteredRules.png', bounds, masks },
  { name: 'Shattered PT Box', src: '/img/frames/shatteredGlass/ShatteredPTBox.png', bounds },
];

const template: FramePackTemplate = {
  id: 'ShatteredGlass',
  label: 'Shattered Glass (BOT)',
  version: 'shatteredGlass',
