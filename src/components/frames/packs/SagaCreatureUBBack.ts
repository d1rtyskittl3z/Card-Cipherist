...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/saga/creature/ub/transform-back/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/saga/creature/ub/transform-back/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/saga/creature/ub/transform-back/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/saga/creature/ub/transform-back/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/saga/creature/ub/transform-back/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/saga/creature/ub/transform-back/m.png', masks },
...
const template: FramePackTemplate = {
  id: 'SagaCreatureUBBack',
  label: 'Saga Creatures (Universes Beyond) (Back)',
  version: 'sagaCreatureUBTransformBack',
