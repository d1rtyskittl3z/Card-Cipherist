...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/planeswalker/borderless/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/planeswalker/borderless/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/planeswalker/borderless/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/planeswalker/borderless/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/planeswalker/borderless/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/planeswalker/borderless/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/planeswalker/borderless/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/planeswalker/borderless/l.png', masks },
];
...
const template: FramePackTemplate = {
  id: 'PlaneswalkerBorderless',
  label: 'Borderless',
  version: 'planeswalkerBorderless',
