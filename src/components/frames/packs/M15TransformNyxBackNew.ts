...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/transform/nyx/new/backW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/transform/nyx/new/backU.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/transform/nyx/new/backB.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/transform/nyx/new/backR.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/transform/nyx/new/backG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/transform/nyx/new/backM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/transform/nyx/new/backA.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15TransformNyxBackNew',
  label: 'Nyx (Back)',
  version: 'm15TransformNyxBackNew',
