...
const frames: FrameItem[] = [
  { name: 'Transform Front', src: '/img/frames/m15/sdcc15/transformFront.svg' },
  { name: 'Transform Back', src: '/img/frames/m15/sdcc15/transformBack.svg' },
  { name: 'Power/Toughness', src: '/img/frames/m15/sdcc15/pt.svg' },
  { name: 'Color Identity Pip', src: '/img/frames/m15/sdcc15/ciPip.svg' },
];

const template: FramePackTemplate = {
  id: 'TransformSDCC15',
  label: 'Transform (SDCC15 Blackout)',
  version: 'transformSDCC15',
