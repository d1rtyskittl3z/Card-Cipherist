...
const masks: Mask[] = [
  ...
  { src: '/img/frames/m15/fullText/type.svg', name: 'Type' },
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/fullText/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/fullText/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/fullText/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/fullText/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/fullText/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/fullText/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/fullText/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/fullText/l.png', masks },
  { name: 'White Land Frame', src: '/img/frames/m15/fullText/wl.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/m15/fullText/ul.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/m15/fullText/bl.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/m15/fullText/rl.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/m15/fullText/gl.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/m15/fullText/ml.png', masks },
