...
// Common masks shared by front/back Nyx modal frames
const masks: Mask[] = [
...
const frames: FrameItem[] = [
  // Front frames
  { name: 'White Frame (Front)', src: '/img/frames/modal/nyx/w.png', masks },
  { name: 'Blue Frame (Front)', src: '/img/frames/modal/nyx/u.png', masks },
  { name: 'Black Frame (Front)', src: '/img/frames/modal/nyx/b.png', masks },
  { name: 'Red Frame (Front)', src: '/img/frames/modal/nyx/r.png', masks },
  { name: 'Green Frame (Front)', src: '/img/frames/modal/nyx/g.png', masks },
  { name: 'Multicolored Frame (Front)', src: '/img/frames/modal/nyx/m.png', masks },
  { name: 'Artifact Frame (Front)', src: '/img/frames/modal/nyx/a.png', masks },

  // Front power/toughness badges
  ...
  // Back frames
  { name: 'White Frame (Back)', src: '/img/frames/modal/nyx/back/w.png', masks },
  { name: 'Blue Frame (Back)', src: '/img/frames/modal/nyx/back/u.png', masks },
  { name: 'Black Frame (Back)', src: '/img/frames/modal/nyx/back/b.png', masks },
  { name: 'Red Frame (Back)', src: '/img/frames/modal/nyx/back/r.png', masks },
  { name: 'Green Frame (Back)', src: '/img/frames/modal/nyx/back/g.png', masks },
  { name: 'Multicolored Frame (Back)', src: '/img/frames/modal/nyx/back/m.png', masks },
  { name: 'Artifact Frame (Back)', src: '/img/frames/modal/nyx/back/a.png', masks },

  // Back power/toughness badges
