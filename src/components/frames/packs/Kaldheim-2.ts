...
// Shared masks
const masks: Mask[] = [
  { src: '/img/frames/kaldheim/maskDetails.png', name: 'Details' },
  { src: '/img/frames/kaldheim/maskPinline.png', name: 'Pinline' },
  { src: '/img/frames/kaldheim/maskTitle.png', name: 'Title' },
  { src: '/img/frames/kaldheim/maskType.png', name: 'Type' },
  { src: '/img/frames/kaldheim/maskTextbox.png', name: 'Rules' },
  { src: '/img/frames/kaldheim/maskBorder.png', name: 'Border' },
  { src: '/img/frames/kaldheim/maskFrame.png', name: 'Frame' }
];
...
const iconBounds: Bounds = { x: 0.02, y: 0.0529, width: 0.098, height: 0.0591 };
const reminderBounds: Bounds = { x: 0.03, y: 0.8886, width: 0.438, height: 0.0429 };

// Frames array
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/kaldheim/frameW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/kaldheim/frameU.png', masks },
  { name: 'Black Frame', src: '/img/frames/kaldheim/frameB.png', masks },
  { name: 'Red Frame', src: '/img/frames/kaldheim/frameR.png', masks },
  { name: 'Green Frame', src: '/img/frames/kaldheim/frameG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/kaldheim/frameM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/kaldheim/frameA.png', masks },
...
const template: FramePackTemplate = {
  ...
  artBounds: { x: 0.1047, y: 0.1158, width: 0.7907, height: 0.462 },
