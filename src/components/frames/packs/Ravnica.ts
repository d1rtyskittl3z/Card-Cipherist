...
const masks: Mask[] = [
  { src: '/img/frames/ravnica/maskTitleInner.png', name: 'Title' },
  { src: '/img/frames/ravnica/maskTypeInner.png', name: 'Type' },
  { src: '/img/frames/ravnica/maskRules.png', name: 'Rules' },
];

const crownBounds = { x: 91 / 1500, y: 0, width: 1318 / 1500, height: 91 / 2100 };
const ptBounds = { x: 1152 / 1500, y: 1855 / 2100, width: 287 / 1500, height: 145 / 2100 };

const ptMasks: Mask[] = [
  { src: '/img/frames/ravnica/pt/highlightsLeft.png', name: 'Highlights (Left)' },
  { src: '/img/frames/ravnica/pt/highlightsRight.png', name: 'Highlights (Right)' },
];

const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/ravnica/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/ravnica/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/ravnica/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/ravnica/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/ravnica/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/ravnica/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/ravnica/a.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/ravnica/c.png', masks },
...
const template: FramePackTemplate = {
  id: 'Ravnica',
  label: 'Ravnica City (MOM)',
  version: 'ravnica',
  artBounds: { x: 108 / 1500, y: 237 / 2100, width: 1283 / 1500, height: 930 / 2100 },
