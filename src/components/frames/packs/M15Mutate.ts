...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/mutate/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/mutate/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/mutate/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/mutate/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/mutate/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/mutate/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/mutate/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/mutate/l.png', masks },
...
const template: FramePackTemplate = {
  ...
  label: 'Mutate (Ikoria)',
  version: 'mutate',
  artBounds: { x: 0.0614, y: 0.1129, width: 0.8774, height: 0.6434 },
