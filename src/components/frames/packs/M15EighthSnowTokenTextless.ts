...
// Shared masks for M15 Eighth Edition Snow Token Textless style frames
const masks: Mask[] = [
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/m15-eighth/token/snow-textless/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/m15-eighth/token/snow-textless/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/m15-eighth/token/snow-textless/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/m15-eighth/token/snow-textless/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/m15-eighth/token/snow-textless/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/m15-eighth/token/snow-textless/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/m15-eighth/token/snow-textless/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/m15-eighth/token/snow-textless/l.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15EighthSnowTokenTextless',
  label: 'Snow (Textless)',
  version: 'm15EighthSnowTokenTextless',
