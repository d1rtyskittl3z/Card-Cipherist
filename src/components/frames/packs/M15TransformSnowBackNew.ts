...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/transform/snow/new/backW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/transform/snow/new/backU.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/transform/snow/new/backB.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/transform/snow/new/backR.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/transform/snow/new/backG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/transform/snow/new/backM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/transform/snow/new/backA.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/transform/snow/new/backL.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15TransformSnowBackNew',
  label: 'Snow (Back)',
  version: 'm15TransformSnowBackNew',
