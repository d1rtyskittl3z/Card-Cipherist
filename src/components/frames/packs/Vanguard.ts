...
const template: FramePackTemplate = {
  ...
  label: 'Vanguard',
  version: 'vanguard',
  artBounds: { x: 0.1214, y: 0.0991, width: 0.7567, height: 0.4767 },
  setSymbolBounds: { x: 0.5, y: 0.9458, width: 0.0307, height: 0.022, vertical: 'center', horizontal: 'center' },
  ...
  loadBottomInfo: {
    illus: { name: 'Artist', text: 'Illus. {elemidinfo-artist}', x: 0.0647, y: 0.8977, width: 0.8707, height: 0.0171, font: 'mplantin', size: 0.0167, color: 'black', align: 'center' },
  },
};
