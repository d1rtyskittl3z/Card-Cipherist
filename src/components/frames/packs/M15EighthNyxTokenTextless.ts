...
// Shared masks for M15 Eighth Edition Nyx Token Textless style frames
const masks: Mask[] = [
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/m15-eighth/token/nyx-textless/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/m15-eighth/token/nyx-textless/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/m15-eighth/token/nyx-textless/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/m15-eighth/token/nyx-textless/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/m15-eighth/token/nyx-textless/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/m15-eighth/token/nyx-textless/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/m15-eighth/token/nyx-textless/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/m15-eighth/token/nyx-textless/l.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15EighthNyxTokenTextless',
  label: 'Nyx (Textless)',
  version: 'm15EighthNyxTokenTextless',
