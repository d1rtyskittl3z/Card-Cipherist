...
// Shared masks for M15 Eighth Edition style frames
const masks: Mask[] = [
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/m15-eighth/regular/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/m15-eighth/regular/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/m15-eighth/regular/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/m15-eighth/regular/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/m15-eighth/regular/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/m15-eighth/regular/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/m15-eighth/regular/a.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/m15-eighth/regular/l.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/custom/m15-eighth/regular/c.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/custom/m15-eighth/regular/v.png', masks },
  ...
  { name: 'White Land Frame', src: '/img/frames/custom/m15-eighth/regular/wl.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/custom/m15-eighth/regular/ul.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/custom/m15-eighth/regular/bl.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/custom/m15-eighth/regular/rl.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/custom/m15-eighth/regular/gl.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/custom/m15-eighth/regular/ml.png', masks },
...
const template: FramePackTemplate = {
  ...
  loadBottomInfo: {
    top: { name: 'Artist', text: '\uFFEE {elemidinfo-artist}', x: 0.0647, y: 1973 / 2100, width: 0.8107, height: 0.0248, oneLine: true, font: 'belerenbsc', size: 0.02095, color: 'black', conditionalColor: 'M15 Border,Black Frame,Land Frame,Colorless Frame,Vehicle Frame,White Land Frame,Blue Land Frame,Black Land Frame,Red Land Frame,Green Land Frame,Multicolored Land Frame:white' },
  },
