...
const template: FramePackTemplate = {
  ...
  loadBottomInfo: {
    top: { name: 'Artist', text: 'Illus. {elemidinfo-artist}', x: 0.1, y: 1872 / 2100, width: 0.8, height: 0.0267, oneLine: true, font: 'mplantin', size: 0.0267, shadowX: 0.0021, shadowY: 0.0015, color: 'white' },
  },
};
