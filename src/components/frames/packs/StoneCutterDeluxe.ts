...
const masks: Mask[] = [
  { src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskPinlines.png', name: 'Pinlines' },
  { src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskFrame.png', name: 'Frame' },
  { src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskRules.png', name: 'Rules Text' },
  { src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskDual.png', name: 'Dual Land' },
  { src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskBorderless.png', name: 'Borderless' },
  { src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskBorder.png', name: 'Border' },
];
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/m.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/c.png', masks },
  { name: 'Land Frame', src: '/img/frames/custom/stoneCutter/stoneCutterDeluxe/L.png', masks },
