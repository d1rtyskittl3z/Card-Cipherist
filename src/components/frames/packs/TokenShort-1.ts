...
const masks: Mask[] = [
  { src: '/img/frames/token/short/m15MaskPinlineSuperShort.png', name: 'Pinline' },
  { src: '/img/frames/m15/regular/m15MaskTitle.png', name: 'Title' },
  { src: '/img/frames/token/short/m15MaskTypeShort.png', name: 'Type' },
  { src: '/img/frames/token/short/m15MaskRulesShort.png', name: 'Rules' },
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/token/short/tokenFrameWShort.png', masks },
  { name: 'Blue Frame', src: '/img/frames/token/short/tokenFrameUShort.png', masks },
  { name: 'Black Frame', src: '/img/frames/token/short/tokenFrameBShort.png', masks },
  { name: 'Red Frame', src: '/img/frames/token/short/tokenFrameRShort.png', masks },
  { name: 'Green Frame', src: '/img/frames/token/short/tokenFrameGShort.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/token/short/tokenFrameMShort.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/token/short/tokenFrameAShort.png', masks },
  { name: 'Land Frame', src: '/img/frames/token/short/tokenFrameLShort.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/token/short/frameC.png', masks },
...
const template: FramePackTemplate = {
  ...
  setSymbolBounds: { x: 0.9213, y: (0.6743 * 2100 + 59) / 2100, width: 0.12, height: 0.041, vertical: 'center', horizontal: 'right' },
  watermarkBounds: { x: 0.5, y: (0.8177 * 2100 + 59) / 2100, width: 0.75, height: (0.1472 * 2100 - 59) / 2100 },
  frames,
  text: {
