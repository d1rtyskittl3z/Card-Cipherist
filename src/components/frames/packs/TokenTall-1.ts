...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/token/tall/tokenFrameWTall.png', masks },
  { name: 'Blue Frame', src: '/img/frames/token/tall/tokenFrameUTall.png', masks },
  { name: 'Black Frame', src: '/img/frames/token/tall/tokenFrameBTall.png', masks },
  { name: 'Red Frame', src: '/img/frames/token/tall/tokenFrameRTall.png', masks },
  { name: 'Green Frame', src: '/img/frames/token/tall/tokenFrameGTall.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/token/tall/tokenFrameMTall.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/token/tall/tokenFrameATall.png', masks },
  { name: 'Land Frame', src: '/img/frames/token/tall/tokenFrameLTall.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/token/tall/frameC.png', masks },
  { name: 'Snow Frame', src: '/img/frames/token/tall/snow.png', masks },
