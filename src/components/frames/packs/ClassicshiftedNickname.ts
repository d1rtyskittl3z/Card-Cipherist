...
const fullBounds: Bounds = { x: 0, y: 0, width: 1, height: 1 };
...
const frames: FrameItem[] = [
  ...
  { name: 'White Nickname', src: '/img/frames/custom/classicshifted/nickname/w.png', bounds: fullBounds },
  { name: 'Blue Nickname', src: '/img/frames/custom/classicshifted/nickname/u.png', bounds: fullBounds },
  { name: 'Black Nickname', src: '/img/frames/custom/classicshifted/nickname/b.png', bounds: fullBounds },
  { name: 'Red Nickname', src: '/img/frames/custom/classicshifted/nickname/r.png', bounds: fullBounds },
  { name: 'Green Nickname', src: '/img/frames/custom/classicshifted/nickname/g.png', bounds: fullBounds },
  { name: 'Multicolored Nickname', src: '/img/frames/custom/classicshifted/nickname/m.png', bounds: fullBounds },
  { name: 'Artifact Nickname', src: '/img/frames/custom/classicshifted/nickname/a.png', bounds: fullBounds },
  { name: 'Land Nickname', src: '/img/frames/custom/classicshifted/nickname/L.png', bounds: fullBounds },
];

const template: FramePackTemplate = {
  id: 'ClassicshiftedNickname',
  label: 'Classicshifted Nickname',
