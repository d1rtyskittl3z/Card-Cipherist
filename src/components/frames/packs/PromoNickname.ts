...
const bounds2 = { x: 0.024, y: 0.0172, width: 0.952, height: 0.1286 };
const bounds3 = { x: 0.0494, y: 0.0405, width: 0.9014, height: 0.1053 };

const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/promo/nickname/m15PromoNicknameFrameW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/promo/nickname/m15PromoNicknameFrameU.png', masks },
  { name: 'Black Frame', src: '/img/frames/promo/nickname/m15PromoNicknameFrameB.png', masks },
  { name: 'Red Frame', src: '/img/frames/promo/nickname/m15PromoNicknameFrameR.png', masks },
  { name: 'Green Frame', src: '/img/frames/promo/nickname/m15PromoNicknameFrameG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/promo/nickname/m15PromoNicknameFrameM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/promo/nickname/m15PromoNicknameFrameA.png', masks },
  { name: 'Land Frame', src: '/img/frames/promo/nickname/m15PromoNicknameFrameL.png', masks },
  { name: 'White Crown Nickname', src: '/img/frames/m15/nickname/m15NicknameCrownW.png', masks: masks2, bounds: bounds2 },
...
const template: FramePackTemplate = {
  id: 'PromoNickname',
  label: 'Nickname Frames',
  version: 'promoNickname',
  notice: 'Nickname frames include crown and title overlays for alternate card names. When frames from this pack are used, the title and nickname text fields will swap rendering positions: nickname text displays in the crown area, and title text displays at the top.',
