...
// Shared masks for M15 Eighth Nyx Token frames
const masks: Mask[] = [
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/custom/m15-eighth/token/nyx/w.png', masks },
  { name: 'Blue Frame', src: '/img/frames/custom/m15-eighth/token/nyx/u.png', masks },
  { name: 'Black Frame', src: '/img/frames/custom/m15-eighth/token/nyx/b.png', masks },
  { name: 'Red Frame', src: '/img/frames/custom/m15-eighth/token/nyx/r.png', masks },
  { name: 'Green Frame', src: '/img/frames/custom/m15-eighth/token/nyx/g.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/custom/m15-eighth/token/nyx/m.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/custom/m15-eighth/token/nyx/a.png', masks },
//   { name: 'Land Frame', src: '/img/frames/custom/m15-eighth/token/nyx/l.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15EighthNyxToken',
  label: 'Nyx',
  version: 'm15EighthNyxToken',
