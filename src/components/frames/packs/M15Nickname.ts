...
// M15 Nickname ("Godzilla") showcase frames
// Provides classic nickname crowns, titles, and power/toughness plates
...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/nickname/m15NicknameFrameW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/nickname/m15NicknameFrameU.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/nickname/m15NicknameFrameB.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/nickname/m15NicknameFrameR.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/nickname/m15NicknameFrameG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/nickname/m15NicknameFrameM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/nickname/m15NicknameFrameA.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/nickname/m15NicknameFrameL.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15Nickname',
  label: 'Nickname ("Godzilla")',
  version: 'm15Nickname',
  notice: 'Nickname showcase frames include crown/title overlays and matching power/toughness plates. When a frame from this pack is added, a "Nickname" text field will be added automatically with the correct layout.',
