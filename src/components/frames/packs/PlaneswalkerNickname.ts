...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/planeswalker/nickname/planeswalkerNicknameFrameW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/planeswalker/nickname/planeswalkerNicknameFrameU.png', masks },
  { name: 'Black Frame', src: '/img/frames/planeswalker/nickname/planeswalkerNicknameFrameB.png', masks },
  { name: 'Red Frame', src: '/img/frames/planeswalker/nickname/planeswalkerNicknameFrameR.png', masks },
  { name: 'Green Frame', src: '/img/frames/planeswalker/nickname/planeswalkerNicknameFrameG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/planeswalker/nickname/planeswalkerNicknameFrameM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/planeswalker/nickname/planeswalkerNicknameFrameA.png', masks },
  { name: 'Colorless Frame', src: '/img/frames/planeswalker/nickname/planeswalkerNicknameFrameL.png', masks },
];

const template: FramePackTemplate = {
  id: 'PlaneswalkerNickname',
  label: 'Nickname',
  version: 'planeswalkerNickname',
