...
const template: FramePackTemplate = {
  id: 'StoneCutterDeluxeClass',
  label: 'StoneCutter Class(y)',
  notice: 'When you load a Class frame version, a "Class" tab will appear. This tab controls the placement and levels for Class abilities.',
  version: 'classStoneCutterDeluxe',
