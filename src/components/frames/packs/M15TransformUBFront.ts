...
const frames: FrameItem[] = [
  { name: 'White Frame', src: '/img/frames/m15/transform/ub/frontW.png', masks },
  { name: 'Blue Frame', src: '/img/frames/m15/transform/ub/frontU.png', masks },
  { name: 'Black Frame', src: '/img/frames/m15/transform/ub/frontB.png', masks },
  { name: 'Red Frame', src: '/img/frames/m15/transform/ub/frontR.png', masks },
  { name: 'Green Frame', src: '/img/frames/m15/transform/ub/frontG.png', masks },
  { name: 'Multicolored Frame', src: '/img/frames/m15/transform/ub/frontM.png', masks },
  { name: 'Artifact Frame', src: '/img/frames/m15/transform/ub/frontA.png', masks },
  { name: 'Vehicle Frame', src: '/img/frames/m15/transform/ub/frontV.png', masks },
  { name: 'Land Frame', src: '/img/frames/m15/transform/ub/frontL.png', masks },
  { name: 'White Enchantment Frame', src: '/img/frames/m15/transform/ub/frontWE.png', masks },
  { name: 'Blue Enchantment Frame', src: '/img/frames/m15/transform/ub/frontUE.png', masks },
  { name: 'Black Enchantment Frame', src: '/img/frames/m15/transform/ub/frontBE.png', masks },
  { name: 'Red Enchantment Frame', src: '/img/frames/m15/transform/ub/frontRE.png', masks },
  { name: 'Green Enchantment Frame', src: '/img/frames/m15/transform/ub/frontGE.png', masks },
  { name: 'Multicolored Enchantment Frame', src: '/img/frames/m15/transform/ub/frontME.png', masks },
  { name: 'Artifact Enchantment Frame', src: '/img/frames/m15/transform/ub/frontAE.png', masks },
  ...
  { name: 'White Land Frame', src: '/img/frames/m15/transform/ub/frontWL.png', masks },
  { name: 'Blue Land Frame', src: '/img/frames/m15/transform/ub/frontUL.png', masks },
  { name: 'Black Land Frame', src: '/img/frames/m15/transform/ub/frontBL.png', masks },
  { name: 'Red Land Frame', src: '/img/frames/m15/transform/ub/frontRL.png', masks },
  { name: 'Green Land Frame', src: '/img/frames/m15/transform/ub/frontGL.png', masks },
  { name: 'Multicolored Land Frame', src: '/img/frames/m15/transform/ub/frontML.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15TransformUBFront',
  label: 'Universes Beyond (Front)',
  version: 'm15TransformUBFront',
