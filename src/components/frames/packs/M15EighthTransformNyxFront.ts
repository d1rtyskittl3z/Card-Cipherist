...
const frames: FrameItem[] = [
  { name: 'Nyx White Frame', src: '/img/frames/custom/m15-eighth/transform/front/nyx/w.png', masks },
  { name: 'Nyx Blue Frame', src: '/img/frames/custom/m15-eighth/transform/front/nyx/u.png', masks },
  { name: 'Nyx Black Frame', src: '/img/frames/custom/m15-eighth/transform/front/nyx/b.png', masks },
  { name: 'Nyx Red Frame', src: '/img/frames/custom/m15-eighth/transform/front/nyx/r.png', masks },
  { name: 'Nyx Green Frame', src: '/img/frames/custom/m15-eighth/transform/front/nyx/g.png', masks },
  { name: 'Nyx Multicolored Frame', src: '/img/frames/custom/m15-eighth/transform/front/nyx/m.png', masks },
  { name: 'Nyx Artifact Frame', src: '/img/frames/custom/m15-eighth/transform/front/nyx/a.png', masks },
...
const template: FramePackTemplate = {
  id: 'M15EighthTransformNyxFront',
  label: 'Nyx (Front)',
  version: 'm15EighthTransformNyxFront',
